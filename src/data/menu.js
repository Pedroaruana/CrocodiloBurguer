...
export const products = [
  ...
  },
  {
    ...
    image: IMG('photo-1525164286253-03d57bc7c1e7'),
  ...
  { id: 7,  category: 'burgers',   name: 'Croco Veggie',      image: IMG('photo-1525059696034-4967a729002e'), rating: 4.5, reviewCount: 189,  description: 'Blend de grão-de-bico e beterraba, queijo brie, espinafre, tomate seco e molho de ervas frescas', price: 36.90, badge: '🌿 Veggie', badgeColor: '#40916c', gradient: 'linear-gradient(145deg, #40916c 0%, #d8f3dc 100%)', emoji: '🥗' },
  ...
  { id: 19, category: 'bebidas',   name: 'Água Mineral 500ml',      image: IMG('photo-1564419320461-6870880221ad'), rating: 4.1, reviewCount: 156, description: 'Com ou sem gás, gelada', price: 5.90, gradient: 'linear-gradient(145deg, #48cae4 0%, #90e0ef 100%)', emoji: '💧' },
  ...
  { id: 28, category: 'extras', name: 'Molho Especial',   image: IMG('photo-1556909114-f6e7ad7d3136'),    rating: 4.7, reviewCount: 178, description: 'Maionese trufada, molho da casa, BBQ defumado ou aioli de alho negro', price: 4.90, gradient: 'linear-gradient(145deg, #2d6a4f 0%, #f9c74f 100%)', emoji: '🫙' },
]
